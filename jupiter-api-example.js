...
export async function buyFunc () {
const quoteResponse = await (
    await fetch('https://quote-api.jup.ag/v6/quote?inputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v\&outputMint=3psH1Mj1f7yUfaD5gh6Zj7epE8hhrMkMETgv5TshQA4o\&amount=100000\&slippageBps=100')
  ).json();
